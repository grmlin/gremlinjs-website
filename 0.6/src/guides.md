...
Adding the new class to <span class="gremlinjs">gremlin.js</span> is the same as before.
...
Reflects the class of the instance (something that Javascript doesn't do innately).
